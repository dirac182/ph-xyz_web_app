   ...
   return(
       <div className="landing-page-container h-screen w-full pr-6">
         ...
         <div className="landing-page-body">
            ...
            <UnitDropdown expand={expandBool} icon="GiMoonOrbit" checkedBoxes = {selectedTopics} onAdd={handleAddTopic} onDelete={handleRemoveTopic} topics={unitThreeTopics}>Unit 3: Circular Motion and Gravitation</UnitDropdown>            
            <UnitDropdown expand={expandBool} icon="MdRocketLaunch" checkedBoxes = {selectedTopics} onAdd={handleAddTopic} onDelete={handleRemoveTopic} topics={unitFourTopics}>Unit 4: Energy</UnitDropdown>            
