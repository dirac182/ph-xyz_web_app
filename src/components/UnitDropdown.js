...
function UnitDropdown({children, topics, onAdd, onDelete, checkedBoxes}) {
    ...
    <div className="w-full p-4 ">
        <div className="cursor-pointer text-lg font-medium p-4 bg-indigo-100 border-2 border-indigo-500 rounded-lg " onClick={handleClick}>
